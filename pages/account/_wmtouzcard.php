<div class="s-bk-lf">
	<div class="acc-title">Webmoneydan Uzcardga o'tkazish</div>
</div>
<div class="silver-bk">
<BR />
<?PHP
$_OPTIMIZATION["title"] = "Webmoneydan Uzcardga o`tkazish";
...
$sozlama = $db->FetchArray();


$min_ser = $sozlama["min_pay"] * $sozlama["ser_per_wmr"];
...
<table cellpadding='3' cellspacing='0' border='0' bordercolor='#336633' align='center' width="99%">
  ...
  $db->Query("SELECT serebro, purse, status, date_add FROM db_payment WHERE user_id = '$usid' ORDER BY id DESC LIMIT 10");
