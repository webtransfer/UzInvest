...
<style type="text/css">
#chat{position:absolute; left:50%; margin-left:-390px; height:500px; width:520px; z-index:1; background:#d6eed5; border:1px solid #fff; border-radius:5px; outline:1px solid #b8ddb5; box-shadow: #000 0px 0px 3px 0px;}
...
#chat .message input[name="comment"]{height:28px; width:500px; padding:0; margin:10px 10px; font-size:15px;}
...
<div id="chat">
	...
	<div class="message">
		<form id="form_com" action="#form_com" method="post">
			<input style="height:50px;" type="text" id="comment" name="comment" maxlength="1055" />
