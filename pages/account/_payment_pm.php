...
<center><h1><span style="font-size: 17pt;"><b>Выплата на PerfectMoney</b></span></h1></center> <BR />
<b>Выплаты на PerfectMoney осуществляются с комиссией 4.4%.<br/>
Минималка для выплаты на PerfectMoney 50<font color="blue"><b>C</b></font>.<br/>
...
<?PHP
 								...
 								if ($initOutput)
	{
		                            ...
		                            {
			                            echo "<center><font color = 'red'>Ошибка:".iconv('windows-1251', 'utf-8', ('<pre>'.print_r($payeer->getErrors(), true).'</pre>'))."</font></center>";
		                            }
		                        }
		                        else
		                        {	                        
...
<table width="99%" border="0" align="center">
  <tr>
    <td><font color="#000;">Введите кошелек [Пример: U39152XX]</font>: </td>
	<td><input type="text" name="purse" size="15"/></td>
  </tr>
  <tr>
    <td><font color="#000;">Отдаете кредиты для вывода</font> [Мин. 50]<font color="#000;">:</font> </td>
