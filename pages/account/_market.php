...
<div class="s-bk-lf">
	<div class="acc-title">БАНК</div>
</div>
<div class="silver-bk">Банк позволит вам обменять все ваши mCOinы за <font color="blue"> Coin</font>, которые можно обменять на реальные 
