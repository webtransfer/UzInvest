...
<center><font color="red">Ув. фермеры! В связи с новым годом на растение "Мандарин" распространяется <b>10% скидка</b>!<br> А это ещё большая выгода! Акция действует 5 дней с 28.12 до 02.01.</font></center>
                               </div>
                               </div>
<br>
<?PHP
...
<div class="fr-block">
	...
	<div class="cl-fr-rg" style="padding-left:20px;">
		...
		<?php
		if($user_data["a_t"] < 1) {
		print '<div class="fr-te-gr"><font color="red">Для покупки этого дерева<br> Вам необходимо купить <br>еще 1 яблоню!</font></div>';
		} else {
		?>
...
<div class="fr-block">
	...
	<div class="cl-fr-rg" style="padding-left:20px;">
		...
		<?php
		if($user_data["b_t"] < 1) {
		print '<div class="fr-te-gr"><font color="red">Для покупки этого дерева<br> Вам необходимо купить <br>еще 1 вишню!</font></div>';
		} else {
...
<div class="fr-block">
	...
	<div class="cl-fr-rg" style="padding-left:20px;">
		...
		<?php
		if($user_data["c_t"] < 1) {
		print '<div class="fr-te-gr"><font color="red">Для покупки этого дерева<br> Вам необходимо купить <br>еще 1 лимон!</font></div>';
		} else {
...
<div class="fr-block">
	...
	<div class="cl-fr-rg" style="padding-left:20px;">
		...
		<div class="fr-te-gr"><font color="green">Стоимость:</font> <font color="#000000"><font color="red"><?=$sonfig_site["amount_f_t"]; ?></font><font color="blue"><b>C</b></font>  [ <font color=red>675руб.<sup>-10%</sup></font>]</font></div>
		<div class="fr-te-gr"><font color="green">Куплено:</font> <font color="#000000"><?=$user_data["f_t"]; ?> шт.</font></div>
		<?php
		if($user_data["d_t"] < 1) {
		print '<div class="fr-te-gr"><font color="red">Для покупки этого дерева<br> Вам необходимо купить <br>еще 1 грушу!</font></div>';
		} else {
...
<div class="fr-block">
	...
	<div class="cl-fr-rg" style="padding-left:20px;">
		...
		<?php
		if($user_data["f_t"] < 1) {
		print '<div class="fr-te-gr"><font color="red">Для покупки этого дерева<br> Вам необходимо купить <br>еще 1 Мандарин!</font></div>';
		} else {
...
<div class="fr-block">
	...
	<div class="cl-fr-rg" style="padding-left:20px;">
		...
		<?php
		if($user_data["e_t"] < 1) {
		print '<div class="fr-te-gr"><font color="red">Для покупки этого дерева<br> Вам необходимо купить <br>еще 1 Тыкву!</font></div>';
		} else {
