...
<center><h1><span style="font-size: 17pt;"><b>Выплата на Yandex.Деньги</b></span></h1></center> <BR />
<b>Выплаты на Yandex.Деньги осуществляются с комиссией 3.4%.<br/>
Минималка для выплаты на Yandex.Money 1040<font color="blue"><b>C</b></font>.<br/>
...
<?PHP
	...
	function ViewPurse($purse){
		...
		if( !ereg("^[0-9]{13,15}$", substr($purse,1)) ) return false;	
		return $purse;
	}
...
<table width="99%" border="0" align="center">
  <tr>
    <td><font color="#000;">Введите кошелек [Пример: 410011666506566]</font>: </td>
	<td><input type="text" name="purse" size="15"/></td>
  </tr>
  <tr>
    <td><font color="#000;">Отдаете кредиты для вывода</font> [Мин. 1040]<font color="#000;">:</font> </td>
