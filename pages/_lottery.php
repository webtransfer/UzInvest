...
<b>1 место - <font color="red">50%</font> от общего банка <font color="green">[<?=($amount_lottery * $num_bil) * 0.5; ?> серебра].</font> <BR />
2 место - <font color="red">25%</font> от общего банка <font color="green">[<?=($amount_lottery * $num_bil) * 0.25; ?> серебра].</font> <BR />
3 место - <font color="red">20%</font> от общего банка <font color="green">[<?=($amount_lottery * $num_bil) * 0.2; ?> серебра].</font> <BR />
Остальные <font color="green">5%</font> составляют комиссию системы.
<BR />
<u>Стоимость билета = <font color="green"><?=$amount_lottery; ?> серебра</u>.</font></b>
<BR />
...
<table cellpadding='3' cellspacing='0' border='0' bordercolor='#336633' align='center' width="99%">
  ...
  <tr>
    <td align="center" class="m-tb"><b>№ билета</b></td>
