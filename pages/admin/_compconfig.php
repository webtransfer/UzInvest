...
<center><a href = "/?menu=admin384&sel=compconfig" class="stn">Текущий конкурс</a> || <a href = "/?menu=admin384&sel=compconfig&add" class="stn">Добавить Конкурс</a> || <a href = "/?menu=admin384&sel=compconfig&list" class="stn">Завершенные</a></center>
<BR />
<?PHP
...
<table width="300" border="0" align="center">
  ...
  <tr>
    ...
    <td align="center"><input type="text" name="1m" value="100" size="10"/></td>
  </tr>
  <tr>
    <td>Приз за 2 место (RUB):</td>
    <td align="center"><input type="text" name="2m" value="50" size="10"/></td>
  </tr>
  <tr>
    <td>Приз за 3 место (RUB):</td>
    <td align="center"><input type="text" name="3m" value="25" size="10"/></td>
  </tr>
  <tr>
