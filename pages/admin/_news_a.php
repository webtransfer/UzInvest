...
<center><a href = "/?menu=admin384&sel=news" class="stn">Список новостей</a> || <a href = "/?menu=admin384&sel=news&add" class="stn">Добавить новость</a></center>
<BR />
...
<?PHP
    ...
    <td align="center"><a href="/?menu=admin384&sel=news&edit=<?=$data["id"]; ?>" class="stn"><?=$data["title"]; ?></a></td>
